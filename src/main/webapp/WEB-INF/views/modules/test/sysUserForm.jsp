...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/test/sysUser/">公户管理列表</a></li>
		<li class="active"><a href="${ctx}/test/sysUser/form?id=${sysUser.id}">公户管理<shiro:hasPermission name="test:sysUser:edit">${not empty sysUser.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="test:sysUser:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="sysUser" action="${ctx}/test/sysUser/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="test:sysUser:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
