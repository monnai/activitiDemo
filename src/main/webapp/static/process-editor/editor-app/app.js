...
var staticContext = appContextRoot?appContextRoot:'';
  ...
  .config(['$selectProvider', '$translateProvider', function ($selectProvider, $translateProvider) {
      ...
      angular.extend($selectProvider.defaults, {
        ...
        $translateProvider.useStaticFilesLoader({
            prefix: staticContext+'/process-editor/editor-app/i18n/',
            suffix: '.json'
        });
            ...
            $rootScope.$on('$includeContentLoaded', function (event) {
	            if (!$rootScope.editorInitialized) {
                  ...
                  var item = sessionStorage.getItem("modelId");
	                var modelId = item?item:EDITOR.UTIL.getParameterByName('modelId');
	                fetchModel(modelId);
