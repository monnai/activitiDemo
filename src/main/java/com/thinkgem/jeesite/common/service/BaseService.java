		...
		if (!user.isAdmin()){
			...
			for (Role r : user.getRoleList()){
				for (String oa : StringUtils.split(officeAlias, ",")){
					// 如果权限范围不存在于dataScope中， 并且机构部门不为空的话，就进行sql的拼接
					if (!dataScope.contains(r.getDataScope()) && StringUtils.isNotBlank(oa)){
						...
						// 所在公司及以下数据
						// xml 必须添加下面两个LEFT JOIN
						// LEFT JOIN sys_user u ON u.id = a.create_by 
						// LEFT JOIN sys_office o ON o.id = u.office_id 
						// 例如： o.id = '2392ec62eca5407e98562ab06cbda05b' OR o.parent_ids LIKE '0,1,f201b530551b453481a0c4b0fd1eb092,2392ec62eca5407e98562ab06cbda05b,%'
			...
			if (!isDataScopeAll){
				if (StringUtils.isNotBlank(userAlias)){
					for (String ua : StringUtils.split(userAlias, ",")){
						// 例如：执行下面语句之前是这样的：
						// OR o.id = '2392ec62eca5407e98562ab06cbda05b' OR o.parent_ids LIKE '0,1,f201b530551b453481a0c4b0fd1eb092,2392ec62eca5407e98562ab06cbda05b,%'
						sqlString.append(" OR " + ua + ".id = '" + user.getId() + "'");
						// 执行了之后：
						// OR o.id = '2392ec62eca5407e98562ab06cbda05b' OR o.parent_ids LIKE '0,1,f201b530551b453481a0c4b0fd1eb092,2392ec62eca5407e98562ab06cbda05b,%' OR u.id = '44c3f50bbc4b479282b65c519e9c7eec'
					}
				}else {
					for (String oa : StringUtils.split(officeAlias, ",")){
						//sqlString.append(" OR " + oa + ".id  = " + user.getOffice().getId());
