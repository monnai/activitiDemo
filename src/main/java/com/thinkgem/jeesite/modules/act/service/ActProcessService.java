...
public class ActProcessService extends BaseService {
	...
	public Page<Object[]> processList(Page<Object[]> page, String category) {
	    ...
	    // 遍历流程定义，通过流程部署id查询部署信息，并保存到List里面
	...
	public Page<ProcessInstance> runningList(Page<ProcessInstance> page, String procInsId, String procDefKey) {
	    ...
	    ProcessInstanceQuery processInstanceQuery = runtimeService.createProcessInstanceQuery(); // 创建一个流程定义查询对象

	    // 设置查询条件
	    if (StringUtils.isNotBlank(procInsId)){
		    processInstanceQuery.processInstanceId(procInsId); // 流程定义id	
	    }
	    
	    if (StringUtils.isNotBlank(procDefKey)){
		    processInstanceQuery.processDefinitionKey(procDefKey); // 流程定义的key
	    }
